            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                    <div className="col-span-2 md:col-span-1">
                        <Image src="/logo.svg" alt="Mentimeter Logo" width={150} height={40} className="mb-4" />
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            {["Overview", "AI builder", "Live polling", "Word cloud", "Quiz", "Presentations"].map((item) => (
                                <li key={item}>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            {["Blog", "Work", "Templates", "Academy", "Comparison", "Stories", "Integrations"].map((item) => (
                                <li key={item}>
                                    <Link href="#" className="text-base text-gray-500 hover:text-gray-900">
                                        {item}
                                    </Link>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            {["Legal", "Policies", "Accessibility", "Help center", "Cookie preferences"].map((item) => (
                                <li key={item}>
                                    <Link href="#" className="text-base text-gray-500 hover:text-gray-900">
                                        {item}
                                    </Link>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            {["The team", "Jobs", "Culture", "Benefits", "Contact us"].map((item) => (
                                <li key={item}>
                                    <Link href="#" className="text-base text-gray-500 hover:text-gray-900">
                                        {item}
                                    </Link>
